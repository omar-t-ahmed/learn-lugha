            ...
            try {
                ...
                if (!token) {
                    ...
                    if (response.ok) {
                        ...
                        // Check if the user is trying to access a paid lesson (lesson 6 or higher)
                        if (id > 5 && !userData.isSubscribed) {
                            router.push("/subscribe"); // Redirect to subscription page if not subscribed
                        } else {
                            setLoading(false); // User is authenticated and allowed to access the lesson
                        }
                    } else {
